...
class AskingType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $builder
            ->add('title',TextType::class, array ('label'=>false, 'attr'=>['placeholder'=>'Titre de la demande']))
            ->add('description',TextareaType::class, array ('label'=>false, 'attr'=>[
                'placeholder'=>'Déscription de la demande',
                'rows'=>'5'
            ]))
...
//            ->add('image',ImageType::class)
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'WP\ExoBundle\Entity\Asking'
        ));
    }
